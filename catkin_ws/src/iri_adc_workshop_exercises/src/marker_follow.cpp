...
class MarkerFollow
{
  public:
    ...
    { 
      ...
      this->odom_sub  = n.subscribe("odom", 1, &MarkerFollow::odom_callback, this);
      
      this->markers_sub = n.subscribe("markers", 1, &MarkerFollow::markers_callback, this);
