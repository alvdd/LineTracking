...
#ifndef _twist_to_manual_control_alg_node_h_
#define _twist_to_manual_control_alg_node_h_
 ...
 *
 */
class TwistToManualControlAlgNode : public algorithm_base::IriBaseAlgorithm<TwistToManualControlAlgorithm>
{
  private:
  ...
  public:
    ...
    */
    TwistToManualControlAlgNode(void);
